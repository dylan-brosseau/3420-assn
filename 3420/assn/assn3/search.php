...
<body class="search_page">
    <nav>
        <ul class="pageheader"> <!-- Unordered list for navigation links in the page header -->
            ...
            <li>
                <a href="index.html">Main Page</a> <!-- Link to the Main Page -->
            </li>
            ...
            <li>
                <a href="list.html">My Public Lists</a> <!-- Link to the user's public lists -->
            </li>

            <li>
                <a href="add_list.html">New List</a> <!-- Link to create a new list -->
            </li>
        </ul>    
    </nav>
    ...
    <div class="parent"> <!-- Parent container for search and lucky sections -->
        <div class="container1">
            ...
            <ul>
                ...
                <li><a href="view_item.html">Search Result 1</a></li> <!-- Result 1 with a link to view details -->
                <li><a href="view_item.html">Search Result 2</a></li> <!-- Result 2 with a link to view details -->
        ...
        <div class="container2">
            ...
            <p><a href="view_item.html">Random Suggestion: Bucket List Item</a></p> <!-- A random suggestion with a link to view details -->
        </div>
    </div>
</body>
</html>
