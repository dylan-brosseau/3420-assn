...
<body>
    <nav>
        <ul class="pageheader">
            <li>
                <a href="login.php">Login</a> <!-- Navigation link to the "Login" page -->
            </li>
            <li>
                <a href="my_profile.php">My Profile</a> <!-- Navigation link to the "My Profile" page -->
            </li>
            <li>
                <a href="index.php">Main Page</a> <!-- Navigation link to the "Main Page" -->
            </li>
            <li>
                <a href="search.php">Discover</a> <!-- Navigation link to the "Discover" page -->
            </li>
            <li>
                <a href="list.php">Public Lists</a> <!-- Navigation link to the "Public Lists" page -->
            </li>
        </ul>   
    </nav>
