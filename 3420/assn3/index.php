...
<body class="index_page">
        ...
        <nav>
            <ul class="pageheader"> <!-- Unordered list for navigation links in the page header -->
                ...
                <li>
                    <a href="list.php">My Public Lists</a> <!-- Link to My Public Lists Page -->
                </li>
    
                <li>
                    <a href="search.php">Discover</a> <!-- Link to the Discover Page -->
                </li>
                ...
                <li>
                    <a href="delete_account.php">Delete Account</a> <!-- Link to the New List Page -->
                </li>
            </ul>    
        </nav>
        ...
        <div class="index_container"> <!-- Container for displaying list details -->   
            ...
            <ul class="bucket_list"> <!-- Unordered list for displaying list items -->
                ...
                <li>
                    ...
                    <p>
                        <a href="view_item.php">View Details</a> | <!-- Link to view the details of the list item -->
                        <a href="edit_item.php">Edit</a> | <!-- Link to edit the list item -->
