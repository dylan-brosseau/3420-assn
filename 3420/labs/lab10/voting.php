...
if (isset($_POST['submit'])) {
  ...
  /* Validation from previous labs is commented out so that your JavaScript can
  ...
  // Check the database and see if their email has already voted
  ...
  // Properly validate their dropdown choice
